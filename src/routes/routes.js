...
const { displayAllFlights, displayAllSummary, displayAirways, displayFlightPlanByID, displayAirRoutes, displayFixes, computeRoute, updateData } = require('../controllers/controller');
...
router.get('/computeRoute', computeRoute);
